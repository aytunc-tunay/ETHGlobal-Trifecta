...
"""This package contains the tests for rounds of PortfolioManager."""
...
class BasePortfolioManagerRoundTest(BaseRoundTestClass):
    """Base test class for PortfolioManager rounds."""
...
class TestDataPullRound(BasePortfolioManagerRoundTest):
    """Tests for DataPullRound."""

    round_class = DataPullRound
...
class TestDecisionMakingRound(BasePortfolioManagerRoundTest):
...
class TestTxPreparationRound(BasePortfolioManagerRoundTest):
    """Tests for TxPreparationRound."""

    round_class = TxPreparationRound
